...
class DroneNavDataset(Dataset):
    ...
    def __init__(self, data_dir: str, processor=None) -> None:
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        # アクション: 4D → 文字列化 [vx, vy, vz, yaw_rate]
        action_4d = list(sample["action_4d"])
        action_str = " ".join([f"{v:.4f}" for v in action_4d])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--grad_accum",    type=int,   default=16,                     help="勾配累積ステップ数")
